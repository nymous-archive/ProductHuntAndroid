...
public class DataProvider {
    ...
    private String getThingsFromWeb(String apiUrl) {
    ...
    public Boolean syncPost() {
        List<Post> list = jsonPostParser.jsonToPosts(getThingsFromWeb(POST_API_END_POINT));
    ...
    public Boolean syncCollection() {
        List<Collection> list = jsonCollectionParser.jsonToCollections(getThingsFromWeb(COLLECTION_API_END_POINT));
